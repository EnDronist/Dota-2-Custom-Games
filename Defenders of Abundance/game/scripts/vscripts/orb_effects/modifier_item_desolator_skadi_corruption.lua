...
function modifier_item_desolator_skadi_corruption:GetStatusEffectName()
	return "particles/status_fx/status_effect_frost.vpcf"
end
function modifier_item_desolator_skadi_corruption:HeroEffectPriority()
   return 1
end
function modifier_item_desolator_skadi_corruption:OnCreated()
...
function modifier_item_desolator_skadi_corruption:OnRefresh()
	self.cold_movement_speed = self:GetAbility():GetSpecialValueFor("skadi_cold_movement_speed")
	self.cold_attack_speed = self:GetAbility():GetSpecialValueFor("skadi_cold_attack_speed")
end
